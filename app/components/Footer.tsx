...
const Footer = () => {
  ...
  return (
    <footer
      id="contact"
      className="mx-5 lg:mx-auto max-w-screen-xl py-5 md:py-9"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="mt-7 md:mt-10 flex flex-col lg:flex-row gap-6 px-5 md:px-12 lg:gap-10 lg:justify-between items-start">
        ...
        <div className=" lg:max-w-[200px]">
          ...
          <p className="text-xs mt-2.5 border-b-8 border-[#FBFB00] rounded-b-md lg:ml-8 lg:block">
            For Individuals
          </p>
        </div>
